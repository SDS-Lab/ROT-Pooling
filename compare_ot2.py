import torch
from pooling.rotlayers import uot_badmm as uot_badmm1
from uot_layers import uot_badmm as uot_badmm0
...
for b in range(B):
    tmp = x1[b, :Ns[b], :]
    print(tmp.shape)
    trans0[b, :Ns[b], :] = uot_badmm0(x=tmp,
